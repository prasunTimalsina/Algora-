...
var twoSum = function(nums, target) {
  ...
  return (
    <div
      className="hidden lg:block mt-12 lg:mt-0 relative overflow-visible"
      style={{ perspective: '1000px' }}
    >
      {/* Code Editor Container with 3D Transform */}
      <div
        className="bg-editor-bg rounded-xl shadow-2xl border border-border-dark overflow-hidden w-[140%] -ml-[20%] relative z-10 mt-14 
               transition-all duration-700 ease-out
               hover:scale-105 
               hover:shadow-[0_0_80px_-10px_rgba(249,115,22,0.6)] 
               hover:-translate-y-3
               transform-gpu"
        style={{
